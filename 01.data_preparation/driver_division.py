...
"""
    CREATE
        ...
        (
             ...
             `future_store_stock_qtty` bigint COMMENT '库存',
             `sale_total` float COMMENT '最近30天的出库量',
             `sale_total_three_days` float COMMENT '最近3天的出库量', 
             `ord_proportion` float COMMENT '未来主仓销量占比',
             `sale_proportion` float COMMENT '未来主仓单量占比',
             `stock_proportion` float COMMENT '未来主仓库存占比' 
        )
